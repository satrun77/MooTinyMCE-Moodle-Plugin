...
/**
 * Strings for component 'editor_mootinymce', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    editor
...
$string['pluginname'] = 'TinyMCE Moo HTML editor';

$string['configuration'] = 'Configuration';
$string['currentinstances'] = 'currentinstances';
$string['language'] = 'language';
$string['resizing'] = 'resizing';
$string['resize_horizontal'] = 'resize_horizontal';
$string['min_height'] = 'min_height';
$string['font_sizes'] = 'font_sizes';
$string['top'] = 'top';
...
$string['toolbar_align'] = 'toolbar_align';
$string['skin'] = 'skin';
$string['fonts'] = 'fonts';
$string['statusbar_location'] = 'statusbar_location';
$string['plugins'] = 'plugins';
$string['row'] = 'Row';
$string['order'] = 'Order';
$string['afterspacer'] = 'After spaceer';

$string['fontselect'] = 'Fonts';
$string['fontsizeselect'] = 'Font Sizes';
$string['formatselect'] = 'Formats';
...
$string['underline'] = 'Under Line';
$string['strikethrough'] = 'Strike Through';
$string['sub'] = 'Sub';
$string['sup'] = 'Sup';
...
$string['pasteword'] = 'Paste Word';
$string['forecolor'] = 'Text Color';
$string['backcolor'] = 'Backgound Color';
$string['ltr'] = 'ltr';
$string['rtl'] = 'rtl';
$string['bullist'] = 'Bulet List';
$string['numlist'] = 'Number List';
$string['outdent'] = 'Outdent';
$string['indent'] = 'Indent';
$string['link'] = 'Link';
$string['unlink'] = 'Unlink';
$string['moodlenolink'] = 'Moodle No Link';
$string['image'] = 'Image';
$string['nonbreaking'] = 'Nonbreaking';
$string['charmap'] = 'Char Map';
$string['moodlemedia'] = 'Moodle Media';
$string['table'] = 'Table';
$string['code'] = 'Code';
$string['button'] = 'Control Buttons';
